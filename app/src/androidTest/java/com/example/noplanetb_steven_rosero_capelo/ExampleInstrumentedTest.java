...
public class ExampleInstrumentedTest extends ActivityInstrumentationTestCase2<BLogIn> {
    ...
    protected void setUp() throws Exception {
        ...
        email = actividad.findViewById(R.id.etuser);
        passw = actividad.findViewById(R.id.etpwd);
        loginbtn = actividad.findViewById(R.id.btnLogIn);
...
//        onView(withId(R.id.password)).perform(typeText(PASSWORD));
        ...
        TouchUtils.tapView(this, email);
        getInstrumentation().sendStringSync(USERNAME);
        // now on value2 entry
        TouchUtils.tapView(this, passw);
